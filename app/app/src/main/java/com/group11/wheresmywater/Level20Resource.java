...
public class Level20Resource {
    ...
    private void loadGraphic() {
        ...
        rock_Region = BitmapTextureAtlasTextureRegionFactory.createFromAsset(rockTextureAtlas, resourceManager._activity, "rock_level20.png", 0, 0);
