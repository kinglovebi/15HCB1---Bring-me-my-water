...
public class Level17Resource {
    ...
    private void loadGraphic() {
        ...
        rock_Region = BitmapTextureAtlasTextureRegionFactory.createFromAsset(rockTextureAtlas, resourceManager._activity, "rock_level17.png", 0, 0);
