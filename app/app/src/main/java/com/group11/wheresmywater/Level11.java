...
public class Level11 extends BaseScene implements IOnSceneTouchListener,
	...
	private void createDuckyEmpty() {
		...
		Vector2[] pos = {new Vector2(215, 505), new Vector2(650, 655),
				new Vector2(500, 885) };
	...
	private void createCoEmpty() {
		...
		Vector2[] pos = {new Vector2(80, 880), new Vector2(160, 880),
				new Vector2(240, 880) };
	...
	private void createRectPipe() {
		// TODO Auto-generated method stub
		rectPipe = new Rectangle(500, 1160, 45, 1, _vbom);
	}
	...
	private void gameOver() {
		...
		((SmoothCamera) _camera).setCenter(200, 1000);
	...
	private void excuteCollidesWithPipe(int index) {
		...
		sprite.setPosition(150, 1030);
		Rectangle rect = new Rectangle(150 + 42.5f, 1030 + 80, 5, 5, _vbom);
