...
public class Level21Resource {
    ...
    private void loadGraphic() {
        ...
        rock_Region = BitmapTextureAtlasTextureRegionFactory.createFromAsset(rockTextureAtlas, resourceManager._activity, "rock_level21.png", 0, 0);
