...
/**
 * The Class Level25Resource.
 */
public class Level25Resource {
    ...
    private ArrayList<BitmapTextureAtlas> listcowaterTextureAtlas;
    public ArrayList<TextureRegion> listcowater_region;
    ...
    private void loadGraphic() {
        ...
        rock_Region = BitmapTextureAtlasTextureRegionFactory.createFromAsset(rockTextureAtlas, resourceManager._activity, "rock_level25.png", 0, 0);
        ...
        wall_Region = BitmapTextureAtlasTextureRegionFactory.createFromAsset(wallTextureAtlas, resourceManager._activity, "wall_3.png", 0, 0);
        ...
        crankyWait_Region= BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(crankyWaitTextureAtlas, resourceManager.getAssets(), "pig_waitwater.png", 0, 0, 4, 4);
        ...
        crankyHaveWater_Region = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(crankyHaveWaterTextureAtlas, resourceManager.getAssets(), "pig_havewater.png", 0, 0, 4, 4);
        ...
        btnRePlay_Region = BitmapTextureAtlasTextureRegionFactory.createFromAsset(btnRePlayTextureAtlas, resourceManager.getAssets(), "btnrestart_3.png", 0, 0);
        ...
        btnPause_Region = BitmapTextureAtlasTextureRegionFactory.createFromAsset(btnPauseTextureAtlas, resourceManager.getAssets(), "btnpause_3.png", 0, 0);
        ...
        int nco = 6;
        listcowater_region = new ArrayList<TextureRegion>();
        listcowaterTextureAtlas = new ArrayList<BitmapTextureAtlas>();
        for (int i = 0; i < nco; i++) {
            BitmapTextureAtlas bmp1 = new BitmapTextureAtlas(resourceManager.getTextureManager(), 100, 45, TextureOptions.BILINEAR_PREMULTIPLYALPHA);
            TextureRegion region1 = BitmapTextureAtlasTextureRegionFactory.createFromAsset(bmp1, resourceManager.getAssets(), "Co.png", 0, 0);
            bmp1.load();

            listcowater_region.add(region1);
            listcowaterTextureAtlas.add(bmp1);
        }
    }
    ...
    private void loadAudio() {
        ...
        try {
            soundGameWin = SoundFactory.createSoundFromAsset(resourceManager.getSoundManager(), resourceManager.getApplicationContext(), "gamewin.mp3");
            soundWaterDrop = SoundFactory.createSoundFromAsset(resourceManager.getSoundManager(), resourceManager.getApplicationContext(), "waterdrop.mp3");
            soundDucky = SoundFactory.createSoundFromAsset(resourceManager.getSoundManager(), resourceManager.getApplicationContext(), "ducky01.mp3");
            soundCrankyCry = SoundFactory.createSoundFromAsset(resourceManager.getSoundManager(), resourceManager.getApplicationContext(), "cranky_cry.mp3");
            soundCrankyLaugh = SoundFactory.createSoundFromAsset(resourceManager.getSoundManager(), resourceManager.getApplicationContext(), "cranky_laugh.mp3");
