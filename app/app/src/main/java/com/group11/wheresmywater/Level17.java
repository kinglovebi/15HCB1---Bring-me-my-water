 ...
 * The Class Level07.
 */
public class Level17 extends BaseScene implements IOnSceneTouchListener,
        IOnMenuItemClickListener {

    /** The _resource. */
    private Level17Resource _resource;
    ...
    public void createScene() {
        ...
        _resource = ResourcesManager.getInstance()._level17Resource;
    ...
    private void createDuckyEmpty() {
        ...
        Vector2[] pos = {new Vector2(440, 740), new Vector2(560, 820),
    ...
    private void createSoil() {
        ...
        float WidthSoil = 500.0f;
        float HeightSoil = 500.0f;
        pos = new Point(110, 500);
        nRow = 10;
        nCol = 10;
    ...
    private void createBody() {
        ...
        BodyProvider.generateBodies("body/body_level17.xml", mPhysicsWorld,
                FIXTURE_DEF);
    }
    ...
    private void excuteCollidesWithPipe(int index) {
        ...
        sprite.setPosition(140, 1080);
        Rectangle rect = new Rectangle(140 + 42.5f, 1080 + 80, 5, 5, _vbom);
    ...
    public void load() {
        // TODO Auto-generated method stub
        ResourcesManager.getInstance().loadLevel17Screen();
    }
}