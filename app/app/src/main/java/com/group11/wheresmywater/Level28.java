 ...
 * The Class Level28.
 */
public class Level28 extends BaseScene implements IOnSceneTouchListener,
        IOnMenuItemClickListener {

    /** The _resource. */
    private Level28Resource _resource;
    ...
    public void createScene() {
        ...
        _resource = ResourcesManager.getInstance()._level28Resource;
    ...
    /**
     * Instantiates a new level28.
     *
     * @param unused the unused
     */
    public Level28(int unused) {
        super(unused);
    }
    ...
    private void addCranky(TiledTextureRegion region) {
        _spriteCranky = new AnimatedSprite(120, 780, 200, 200, region, _vbom);
    ...
    private void createDuckyEmpty() {
        ...
        Vector2[] pos = {new Vector2(180, 600), new Vector2(520, 1220),
                new Vector2(520, 1100) };
    ...
    private void createRectPipe() {
        // TODO Auto-generated method stub
        rectPipe = new Rectangle(200, 1105, 40, 5, _vbom);
    }
    ...
    private void createSoil() {
        ...
        float WidthSoil = 1000.0f;
        float HeightSoil = 1000.0f;
        pos = new Point(130, 310);
        nRow = 10;
        nCol = 10;
       ...
       /* touch(460, 465);
        touch(520, 495); touch(540, 495);
        touch(520, 535); touch(540, 535);
        touch(520, 585); touch(540, 585);
        touch(520, 615); touch(545, 615);
        touch(520, 645); touch(545, 645);
        touch(520, 675); touch(545, 675);
        touch(520, 705); touch(545, 705);
        touch(520, 735); touch(545, 735);
        touch(520, 765); touch(545, 765);
        touch(520, 795); touch(545, 795);
        touch(520, 825); touch(545, 825);
        touch(520, 855); touch(545, 855);
        touch(515, 885);
        touch(520, 915); touch(540, 915);
        touch(525, 945); touch(545, 945);
        touch(525, 975); touch(545, 975);
        touch(525, 1035); touch(545, 1035);
        touch(530, 1065); touch(550, 1065);
        touch(530, 1095); touch(550, 1095);
        touch(530, 1125); touch(560, 1125);
        touch(530, 1155); touch(560, 1155);
        touch(530, 1185); touch(560, 1185);
        touch(530, 1215); touch(560, 1215);
        touch(530, 1245); touch(560, 1245);
        touch(530, 1255); touch(560, 1255);*/
    ...
    private void createBody() {
        ...
        BodyProvider.generateBodies("body/body_level28.xml", mPhysicsWorld,
                FIXTURE_DEF);
    }
    ...
    public void disposeScene() {
        // TODO Auto-generated method stub
        stopMusic();
        ResourcesManager.getInstance().unloadLevel28Screen();
        System.out.println("Level28 Dispose");
    }
    ...
    private void gameOver() {
        ...
        ((SmoothCamera) _camera).setCenter(200, 870);
    ...
    private void excuteCollidesWithPipe(int index) {
        ...
        sprite.setPosition(160, 810);
        Rectangle rect = new Rectangle(160 + 42.5f, 810 + 80, 5, 5, _vbom);
    ...
    public void load() {
        // TODO Auto-generated method stub
        ResourcesManager.getInstance().loadLevel28Screen();
    }
}