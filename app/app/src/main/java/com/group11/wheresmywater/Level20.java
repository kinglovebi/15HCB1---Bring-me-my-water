 ...
 * The Class level05.
 */
public class Level20 extends BaseScene implements IOnSceneTouchListener,
        IOnMenuItemClickListener {

    /** The resource. */
    private Level20Resource _resource;
    ...
    public void createScene() {
        ...
        _resource = ResourcesManager.getInstance()._level20Resource;
    ...
    private void createDuckyEmpty() {
        ...
        Vector2[] pos = {new Vector2(200, 250), new Vector2(200, 680),
                new Vector2(650, 1050) };
    ...
    private void createBody() {
        ...
        BodyProvider.generateBodies("body/body_level20.xml", mPhysicsWorld,
                FIXTURE_DEF);
    }
    ...
    private void excuteCollidesWithPipe(int index) {
        ...
        sprite.setPosition(180, 1025);
        Rectangle rect = new Rectangle(180 + 42.5f, 1025 + 80, 5, 5, _vbom);
    ...
    public void load() {
        // TODO Auto-generated method stub
        ResourcesManager.getInstance().loadLevel20Screen();
    }
}