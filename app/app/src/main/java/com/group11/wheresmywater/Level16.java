 ...
 * The Class Level16.
 */
public class Level16 extends BaseScene implements IOnSceneTouchListener,
        IOnMenuItemClickListener {

    /** The resource. */
    private Level16Resource _resource;
    ...
    public void createScene() {
        ...
        _resource = ResourcesManager.getInstance()._level16Resource;
    ...
    private void createDuckyEmpty() {
        ...
        Vector2[] pos = {new Vector2(150, 850), new Vector2(700, 600),
                new Vector2(700, 1100) };
    ...
    private void createRectPipe() {
        // TODO Auto-generated method stub
        rectPipe = new Rectangle(450, 1170, 45, 1, _vbom);
    }
    ...
    private void createBody() {
        ...
        BodyProvider.generateBodies("body/body_level16.xml", mPhysicsWorld,
                FIXTURE_DEF);
    }
    ...
    public void disposeScene() {
        // TODO Auto-generated method stub
        stopMusic();
        ResourcesManager.getInstance().unloadLevel16Screen();
        System.out.println("Level16 Dispose");
    }
    ...
    public void load() {
        // TODO Auto-generated method stub
        ResourcesManager.getInstance().loadLevel16Screen();
    }
}