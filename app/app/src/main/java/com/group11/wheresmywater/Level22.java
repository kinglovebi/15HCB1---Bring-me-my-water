 ...
 * The Class Level22.
 */
public class Level22 extends BaseScene implements IOnSceneTouchListener,
		IOnMenuItemClickListener {

	/** The resource. */
	private Level22Resource _resource;
	...
	public void createScene() {
		...
		_resource = ResourcesManager.getInstance()._level22Resource;
	...
	private void addCranky(TiledTextureRegion region) {
		_spriteCranky = new AnimatedSprite(130,1050 , 200, 200, region, _vbom);
	...
	private void createDuckyEmpty() {
		...
		Vector2[] pos = {new Vector2(600, 300), new Vector2(500, 700),
				new Vector2(550, 1100) };
	...
	private void createRectPipe() {
		// TODO Auto-generated method stub
		rectPipe = new Rectangle(520, 1240, 45, 1, _vbom);
	}
	...
	private void createSoil() {
		...
		for(int i = 100,j = 600; i < 900 ;i += 30 ,j+=10 )
		{
			touch(i,j);
		}
	...
	private void createBody() {
		...
		BodyProvider.generateBodies("body/body_level22.xml", mPhysicsWorld,
				FIXTURE_DEF);
	}
	...
	public void disposeScene() {
		// TODO Auto-generated method stub
		stopMusic();
		ResourcesManager.getInstance().unloadLevel22Screen();
	...
	private void gameOver() {
		...
		((SmoothCamera) _camera).setCenter(50, 1165);
	...
	public void load() {
		// TODO Auto-generated method stub
		ResourcesManager.getInstance().loadLevel22Screen();
	}
}