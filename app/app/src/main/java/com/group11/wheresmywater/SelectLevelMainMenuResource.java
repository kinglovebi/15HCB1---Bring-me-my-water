 ...
 */
public class SelectLevelMainMenuResource {
    ...
    public TiledTextureRegion menu_Region1;

    public TiledTextureRegion menu_Region2;
    ...
    private void loaGraphic() {
        ...
        menu_Region = BitmapTextureAtlasTextureRegionFactory
                .createTiledFromAsset(menuTextureAtlas,
                        _resourceManager.getAssets(),
                        "menu.png", 0, 0, 5, 1);
        /*menu_Region1 = BitmapTextureAtlasTextureRegionFactory
                .createTiledFromAsset(menuTextureAtlas,
                        _resourceManager.getAssets(),
                        "menu1.png", 0, 0, 5, 1);
        /*menu_Region2 = BitmapTextureAtlasTextureRegionFactory
                .createTiledFromAsset(menuTextureAtlas,
                        _resourceManager.getAssets(),
