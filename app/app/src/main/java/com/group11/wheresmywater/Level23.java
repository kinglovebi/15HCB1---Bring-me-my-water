 ...
 * The Class Level23.
 */
public class Level23 extends BaseScene implements IOnSceneTouchListener,
		IOnMenuItemClickListener {

	/** The _resource. */
	private Level23Resource _resource;
	...
	public void createScene() {
		...
		_resource = ResourcesManager.getInstance()._level23Resource;
	...
	private void createSoil() {
		...
		for(int i = 400,j = 400; i >= 0 ;i-= 30 ,j+=10 )
		{
			touch(i,j);
		}

		for(int i = 400,j = 400; i < 900 ;i+= 30 ,j+=10 )
		{
			touch(i,j);
		}
	...
	private void createBody() {
		...
		BodyProvider.generateBodies("body/body_level23.xml", mPhysicsWorld,
				FIXTURE_DEF);
	}
	...
	public void disposeScene() {
		// TODO Auto-generated method stub
		stopMusic();
		ResourcesManager.getInstance().unloadLevel23Screen();
		System.out.println("Level23 Dispose");
	}
	...
	public void load() {
		// TODO Auto-generated method stub
		ResourcesManager.getInstance().loadLevel23Screen();
	}
}