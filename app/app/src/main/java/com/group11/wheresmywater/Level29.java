 ...
 * The Class level29.
 */
public class Level29 extends BaseScene implements IOnSceneTouchListener,
        IOnMenuItemClickListener {

    /** The resource. */
    private Level29Resource _resource;
    ...
    public void createScene() {
        ...
        _resource = ResourcesManager.getInstance()._level29Resource;
    ...
    private void createDuckyEmpty() {
        ...
        Vector2[] pos = {new Vector2(200, 500), new Vector2(680, 1100),
                new Vector2(730, 800) };
...
// hàng doc dau tien
    ...
    private void createBody() {
        ...
        BodyProvider.generateBodies("body/body_level29.xml", mPhysicsWorld,
                FIXTURE_DEF);
    }
    ...
    public void disposeScene() {
        // TODO Auto-generated method stub
        stopMusic();
        ResourcesManager.getInstance().unloadLevel29Screen();
        System.out.println("Level29 Dispose");
    }
    ...
    public void load() {
        // TODO Auto-generated method stub
        ResourcesManager.getInstance().loadLevel29Screen();
    }
}