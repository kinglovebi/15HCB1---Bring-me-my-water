 ...
 * The Class level09.
 */
public class Level19 extends BaseScene implements IOnSceneTouchListener,
        IOnMenuItemClickListener {

    /** The resource. */
    private Level19Resource _resource;
    ...
    public void createScene() {
        ...
        _resource = ResourcesManager.getInstance()._level19Resource;
    ...
    private void createDuckyEmpty() {
        ...
        Vector2[] pos = {new Vector2(600, 200), new Vector2(220, 200),
                new Vector2(720, 1080) };
    ...
    private void createRectPipe() {
        // TODO Auto-generated method stub
        rectPipe = new Rectangle(530, 1255, 45, 1, _vbom);
    }
...
// hàng doc dau tien
    ...
    private void createBody() {
        ...
        BodyProvider.generateBodies("body/body_level19.xml", mPhysicsWorld,
                FIXTURE_DEF);
    }
    ...
    private void excuteCollidesWithPipe(int index) {
        ...
        sprite.setPosition(180, 1045);
        Rectangle rect = new Rectangle(180 + 42.5f, 1045 + 80, 5, 5, _vbom);
    ...
    public void load() {
        // TODO Auto-generated method stub
        ResourcesManager.getInstance().loadLevel19Screen();
    }
}