 ...
 * The Class Level24.
 */
public class Level24 extends BaseScene implements IOnSceneTouchListener,
        IOnMenuItemClickListener {

    /** The _resource. */
    private Level24Resource _resource;
    ...
    public void createScene() {
        ...
        _resource = ResourcesManager.getInstance()._level24Resource;
    ...
    private void addCranky(TiledTextureRegion region) {
        _spriteCranky = new AnimatedSprite(540, 1010, 200, 200, region, _vbom);
    ...
    private void createDuckyEmpty() {
        ...
        //Vector2[] pos = {new Vector2(100, 700), new Vector2(350, 650),
        //        new Vector2(550, 850) };
        Vector2[] pos = {new Vector2(120, 500), new Vector2(663, 670),
                new Vector2(30, 995) };
    ...
    private void createRectPipe() {
        // TODO Auto-generated method stub
        rectPipe = new Rectangle(140, 1150, 10, 1, _vbom);
    }
    ...
    private void createBody() {
        ...
        BodyProvider.generateBodies("body/body_level24.xml", mPhysicsWorld,
                FIXTURE_DEF);
    }
    ...
    public void disposeScene() {
        // TODO Auto-generated method stub
        stopMusic();
        ResourcesManager.getInstance().unloadLevel24Screen();
        System.out.println("Level24 Dispose");
    }
    ...
    public void load() {
        // TODO Auto-generated method stub
        ResourcesManager.getInstance().loadLevel24Screen();
    }
}