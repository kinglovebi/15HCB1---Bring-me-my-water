 ...
 * The Class Level27.
 */
public class Level27 extends BaseScene implements IOnSceneTouchListener,
        IOnMenuItemClickListener {

    /** The _resource. */
    private Level27Resource _resource;
    ...
    public void createScene() {
        ...
        _resource = ResourcesManager.getInstance()._level27Resource;
    ...
    private void createDuckyEmpty() {
        ...
        Vector2[] pos = {new Vector2(5, 950), new Vector2(450, 1200),
    ...
    private void createSoil() {
        ...
        for(int i = 300,j = 700; i >=0 ;i-= 30, j+=30)
        {
            touch(i,j);
        }
    ...
    private void createBody() {
        ...
        BodyProvider.generateBodies("body/body_level27.xml", mPhysicsWorld,
                FIXTURE_DEF);
    }
    ...
    public void disposeScene() {
        // TODO Auto-generated method stub
        stopMusic();
        ResourcesManager.getInstance().unloadLevel27Screen();
        System.out.println("Level27 Dispose");
    }
    ...
    public void load() {
        // TODO Auto-generated method stub
        ResourcesManager.getInstance().loadLevel27Screen();
    }
}