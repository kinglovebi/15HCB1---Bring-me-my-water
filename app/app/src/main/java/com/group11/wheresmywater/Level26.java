 ...
 * The Class Level22.
 */
public class Level26 extends BaseScene implements IOnSceneTouchListener,
		IOnMenuItemClickListener {

	/** The resource. */
	private Level26Resource _resource;
	...
	public void createScene() {
		...
		_resource = ResourcesManager.getInstance()._level26Resource;
	...
	private void addCranky(TiledTextureRegion region) {
		_spriteCranky = new AnimatedSprite(125, 990, 200, 200, region, _vbom);
	...
	private void createDuckyEmpty() {
		...
		Vector2[] pos = {new Vector2(200, 600), new Vector2(100, 230),
				new Vector2(750, 900) };
	...
	private void createRectPipe() {
		// TODO Auto-generated method stub
		rectPipe = new Rectangle(490, 1170, 45, 1, _vbom);
	}
	...
	private void createSoil() {
		...
		for(int i = 800,j = 250; i >=0 ;i-= 30, j+=3)
		{
			touch(i,j);
		}
/*
		for(int i = 350,j = 800; i < 900 ;i+= 30 ,j+=30 )
		{
			touch(i,j);
		}
...
*/
	...
	private void createBody() {
		...
		BodyProvider.generateBodies("body/body_level26.xml", mPhysicsWorld,
				FIXTURE_DEF);
	}
	...
	public void disposeScene() {
		// TODO Auto-generated method stub
		stopMusic();
		ResourcesManager.getInstance().unloadLevel26Screen();
		System.out.println("Level22 Dispose");
	}
	...
	public void load() {
		// TODO Auto-generated method stub
		ResourcesManager.getInstance().loadLevel26Screen();
	}
}