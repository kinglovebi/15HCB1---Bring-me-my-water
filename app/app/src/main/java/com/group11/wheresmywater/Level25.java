 ...
 * The Class Level25.
 */
public class Level25 extends BaseScene implements IOnSceneTouchListener,
        IOnMenuItemClickListener {

    /** The _resource. */
    private Level25Resource _resource;
    ...
    public void createScene() {
        ...
        _resource = ResourcesManager.getInstance()._level25Resource;
    ...
    private void addCranky(TiledTextureRegion region) {
        _spriteCranky = new AnimatedSprite(500, 1010, 200, 200, region, _vbom);
    ...
    private void createDuckyEmpty() {
        ...
        Vector2[] pos = {new Vector2(140, 550), new Vector2(643, 670),
                new Vector2(45, 965) };
    ...
    private void createCoEmpty() {
        ...
        Vector2[] pos = {new Vector2(250, 390), new Vector2(330, 390),
                new Vector2(410, 390) };
    ...
    private void createBody() {
        ...
        BodyProvider.generateBodies("body/body_level25.xml", mPhysicsWorld,
                FIXTURE_DEF);
    }
    ...
    public void disposeScene() {
        // TODO Auto-generated method stub
        stopMusic();
        ResourcesManager.getInstance().unloadLevel25Screen();
        System.out.println("Level25 Dispose");
    }
    ...
    public void load() {
        // TODO Auto-generated method stub
        ResourcesManager.getInstance().loadLevel25Screen();
    }
}