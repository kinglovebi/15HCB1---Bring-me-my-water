 ...
 * The Class Level27.
 */
public class Level21 extends BaseScene implements IOnSceneTouchListener,
        IOnMenuItemClickListener {

    /** The _resource. */
    private Level21Resource _resource;
    ...
    public void createScene() {
        ...
        _resource = ResourcesManager.getInstance()._level21Resource;
    ...
    private void addCranky(TiledTextureRegion region) {
        _spriteCranky = new AnimatedSprite(100, 1050, 200, 200, region, _vbom);
    ...
    private void createDuckyEmpty() {
        ...
        Vector2[] pos = {new Vector2(200, 600), new Vector2(650, 500),
                new Vector2(450, 1100) };
    ...
    private void createRectPipe() {
        // TODO Auto-generated method stub
        rectPipe = new Rectangle(695, 1100, 40, 5, _vbom);
    }
    ...
    private void createSoil() {
        ...
        for(int i = 400,j = 400; i > 0 ;i -= 30 ,j+=20 )
        {
            touch(i,j);
        }
    ...
    private void createBody() {
        ...
        BodyProvider.generateBodies("body/body_level21.xml", mPhysicsWorld,
                FIXTURE_DEF);
    }
    ...
    public void disposeScene() {
        // TODO Auto-generated method stub
        stopMusic();
        ResourcesManager.getInstance().unloadLevel21Screen();
        System.out.println("Level21 Dispose");
    }
    ...
    protected void createWater(float pX, float pY, int count) {
        ...
        for (int i = 0; i < count; i++) {
            Sprite drop = new Sprite(pX, pY, 75, 75, _resource.water_Region,
                    _vbom);
            drop.setZIndex(10);
    ...
    private void gameOver() {
        ...
        ((SmoothCamera) _camera).setCenter(190, 1165);
    ...
    private void excuteCollidesWithPipe(int index) {
        ...
        sprite.setPosition(150, 1060);
        Rectangle rect = new Rectangle(150 + 42.5f, 1060 + 80, 5, 5, _vbom);
    ...
    public void load() {
        // TODO Auto-generated method stub
        ResourcesManager.getInstance().loadLevel21Screen();
    }
}