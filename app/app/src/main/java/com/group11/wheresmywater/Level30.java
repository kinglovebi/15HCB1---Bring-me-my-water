 ...
 * The Class level30.
 */
public class Level30 extends BaseScene implements IOnSceneTouchListener,
        IOnMenuItemClickListener {

    /** The resource. */
    private Level30Resource _resource;
    ...
    public void createScene() {
        ...
        _resource = ResourcesManager.getInstance()._level30Resource;
    ...
    private void createDuckyEmpty() {
        ...
        Vector2[] pos = {new Vector2(200, 250), new Vector2(110, 800),
                new Vector2(660, 900) };
    ...
    private void createRectPipe() {
        // TODO Auto-generated method stub
        rectPipe = new Rectangle(430, 1050, 45, 1, _vbom);
        rectPipe = new Rectangle(430, 1050, 45, 1, _vbom);
    }
...
for(int i = 0; i<=780 ; i+=20)
{
    touch(i,475);
        ...
        for(int i = 0,j = 700; i <820 ;i+= 20)
        {
            touch(i,j);
        }

        for(int i = 500,j = 700; i <860 ;i+= 30, j+=30)
        {
            touch(i,j);
        }
    ...
    private void createBody() {
        ...
        BodyProvider.generateBodies("body/body_level30.xml", mPhysicsWorld,
                FIXTURE_DEF);
    }
    ...
    public void disposeScene() {
        // TODO Auto-generated method stub
        stopMusic();
        ResourcesManager.getInstance().unloadLevel30Screen();
        System.out.println("Level30 Dispose");
    }
    ...
    private void gameOver() {
        ...
        ((SmoothCamera) _camera).setCenter(190, 1065);
    ...
    public void load() {
        // TODO Auto-generated method stub
        ResourcesManager.getInstance().loadLevel30Screen();
    }
}