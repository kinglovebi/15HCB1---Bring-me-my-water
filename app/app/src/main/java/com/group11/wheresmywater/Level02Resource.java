...
public class Level02Resource {
	...
	private void loadGraphic() {
		...
		crankyWait_Region= BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(crankyWaitTextureAtlas, resourceManager.getAssets(), "Xeko_waitwater.png", 0, 0, 4, 4);
		...
		crankyHaveWater_Region = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(crankyHaveWaterTextureAtlas, resourceManager.getAssets(), "Xeko_havewater.png", 0, 0, 4, 4);
