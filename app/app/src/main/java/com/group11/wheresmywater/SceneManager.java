...
public class SceneManager {
	...
	public static void prepareManager() {
		...
		getInstance().listGameScene.add(new Level16(1));
		getInstance().listGameScene.add(new Level17(1));
		getInstance().listGameScene.add(new Level18(1));
		
		getInstance().listGameScene.add(new Level19(1));
		getInstance().listGameScene.add(new Level20(1));
		getInstance().listGameScene.add(new Level21(1));
		getInstance().listGameScene.add(new Level22(1));
		...
		getInstance().listGameScene.add(new Level27(1));
		getInstance().listGameScene.add(new Level28(1));
		getInstance().listGameScene.add(new Level29(1));
		getInstance().listGameScene.add(new Level30(1));
	...
	public final void loadSelectLevelScene1(final Engine mEngine) {
		_currentScene.disposeScene();
		setScene(_loadScene);
		mEngine.registerUpdateHandler(new TimerHandler(0.1f,
				new ITimerCallback() {
					public void onTimePassed(final TimerHandler pTimerHandler) {
						mEngine.unregisterUpdateHandler(pTimerHandler);
						ResourcesManager.getInstance().loadSelectLevelScreen1();
						setScene(new SelectLevelScene1());
					}
				}));
	}

	public final void loadSelectLevelScene2(final Engine mEngine) {
		_currentScene.disposeScene();
		setScene(_loadScene);
		mEngine.registerUpdateHandler(new TimerHandler(0.1f,
				new ITimerCallback() {
					public void onTimePassed(final TimerHandler pTimerHandler) {
						mEngine.unregisterUpdateHandler(pTimerHandler);
						ResourcesManager.getInstance().loadSelectLevelScreen2();
						setScene(new SelectLevelScene2());
					}
				}));
	}

	public final void loadSelectLevelMainMenu(final Engine mEngine){
		_currentScene.disposeScene();
		setScene(_loadScene);
		mEngine.registerUpdateHandler(new TimerHandler(0.1f,
				new ITimerCallback() {
					public void onTimePassed(final TimerHandler pTimerHandler) {
						mEngine.unregisterUpdateHandler(pTimerHandler);
						//ResourcesManager.getInstance().loadSelectLevelScreen();
						ResourcesManager.getInstance().loadSelectLevelMainMenuScreen();
						//setScene(new SelectLevelScene());
						setScene(new SelectLevelMainMenu());
					}
				}));
	}
